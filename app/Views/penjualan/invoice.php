...
<table cellpadding="0" >
    <tr>
        <th width="10%">Nama</th>
        <th width="40%">: <strong>NAMA</strong></th>
        <th width="10%">Sales</th>
        <th width="40%">: <strong>Administrator</strong></th>
    </tr>
    <tr>
        <th width="10%">Alamat</th>
        <th width="40%">: <strong>JL..</strong></th>
...
<table id="tb-item" cellpadding="4" >
    ...
    <tr>
        <td style="height: 20px">Pembelian Obat</td>
...
<p>BCA: IDR<br/>A/C : 164-800-3325<br/>A/N : APOTEK PERMATA</p>
<p>&nbsp;</p>
<table cellpadding="4" >
    <tr>
