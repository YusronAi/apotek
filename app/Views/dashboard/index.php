    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/index">
                ...
                <img width="100px" src="img/permata.png" alt="">
                </div>
                <div class="sidebar-brand-text mx-3">APOTEK <sup style="color : yellow">PERMATA</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons">OBAT ANTIBIOTIK</a>
                        <a class="collapse-item" href="components/cards">Herbal</a>
                    </div>
                </div>
            </li>
